...
export { default as DashboardAdmin } from "./admin/dashboard/DashboardAdmin";
export { default as Inicio } from "./admin/inicio/Inicio";

export { default as Productos } from "./admin/productos/Productos";
