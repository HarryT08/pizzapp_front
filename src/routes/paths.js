...
export const PRODUCTOS_ADMIN = "/productos";
export const AGREGAR_PRODUCTO_ADMIN = "/productos/agregar";
export const EDITAR_PRODUCTO_ADMIN = "/productos/editar";
export const AGREGAR_BEBIDA_ADMIN = "/bebidas/agregar";
export const EDITAR_BEBIDA_ADMIN = "/bebidas/editar";
export const INGREDIENTES_ADMIN = "/ingredientes";
export const BEBIDAS_ADMIN = "/bebidas";
export const ORDENES_ADMIN = "/ordenes";
...
export const CONFIRMAR_ORDEN_MESERO = "/confirmar-orden";
